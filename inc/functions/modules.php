...
function secupress_get_modules() {
	...
	$modules = array(
		...
		'backups'         => array(
			...
			'with_form'   => false,
			'description' => array(
				__( 'Reduce the risks of losing your content because of an attack by backing up your database and files.', 'secupress' ),
		...
		'antispam'        => array(
			...
			'summaries'   => array(
				...
				'normal' => __( 'Traffic done by bot represents about 60% of the internet. Some bots are spammers. Don\'t let them do that!', 'secupress' ),
			),
			'description' => array(
				__( 'Comments are great for your website, but bot traffic represents about 60 % of the internet. Some bots are spammers, and they just want to add their content to your website. Don\'t let them do that!', 'secupress' ),
