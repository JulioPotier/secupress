...
global 	$priorities;
$priorities = array(    'high' => array( 'title' => __( 'High Priority', 'secupress' ), 'description' => __( 'These tests should be fixed now.', 'secupress' ), ),
...
$statuses_point = array('notscannedyet' => 'a',
                        'bad' => 'b',
                        'warning' => 'c',
                        'good' => 'd',
                    );
