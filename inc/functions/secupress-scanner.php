...
global $priorities, $statuses_point, $secupress_tests;

$priorities = array(
	'high'   => array( 'title' => __( 'High Priority', 'secupress' ),   'description' => __( 'These tests should be fixed now.', 'secupress' ), ),
	'medium' => array( 'title' => __( 'Medium Priority', 'secupress' ), 'description' => __( 'These tests should be fixed when you can if no conflict are found', 'secupress' ), ),
	'low'    => array( 'title' => __( 'Low Priority', 'secupress' ),    'description' => __( 'These tests should be fixed to improve your security, but not mandatory.', 'secupress' ), ),
);


$statuses_point = array(
	'notscannedyet' => 'a',
	'bad'           => 'b',
	'warning'       => 'c',
	'good'          => 'd',
...
$secupress_tests = array(
	...
	'high' => array(
		...
		'directory_listing' => array(
			...
			'msg_good'     => __( 'Your site doesn\'t reveal the file list.', 'secupress' ),
		...
		'common_flaws' => array(
			...
			'msg_good'     => _n_noop( 'All is ok, %d test passed.', 'All is ok, %d tests passed.', 'secupress' ),
	...
	'low' => array(
		...
		'login_errors_disclose' => array(
			...
			'msg_good'     => __( 'Your site doesn\'t reveal login errors.', 'secupress' ),
			'details'      => __( '////Don\'t let them easily find these informations.', 'secupress' ),
			'type'         => __( 'WordPress', 'secupress' ),
		),
