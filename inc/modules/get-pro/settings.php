...
if ( ! $plans ) {
	...
	$impossible = sprintf( '<p style="font-style:italic;text-align:center;">' . __( 'Impossible to get online prices, please check %sonline prices%s to get the last ones.', 'secupress' ), '<a href="https://secupress.me/downloads/secupress/" target="_blank">', '</a>' ) . '</p>';
}
?>
