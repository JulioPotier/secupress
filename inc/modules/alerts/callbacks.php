...
function __secupress_alerts_settings_callback( $settings ) {
	...
	// Daily Reporting.
	__secupress_daily_reporting_settings_callback( $modulenow, $settings, $activate );
...
function __secupress_event_alerts_settings_callback( $modulenow, &$settings, $activate ) {
	// Activate/deactivate.
	secupress_manage_submodule( $modulenow, 'event-alerts', ! empty( $activate['event-alerts_activated'] ) && ! empty( $settings['notification-types_types'] ) );
 ...
 * @param (bool|array) $activate  Used to (de)activate plugins.
 */
function __secupress_daily_reporting_settings_callback( $modulenow, &$settings, $activate ) {
	// Activate/deactivate.
	if ( secupress_is_pro() ) {
		secupress_manage_submodule( $modulenow, 'daily-reporting', ! empty( $activate['daily-reporting_activated'] ) && ! empty( $settings['notification-types_types'] ) );
	} else {
