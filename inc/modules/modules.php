	...
	return array(
		...
		'antispam'        => array(
			...
			'description' => array(
				...
				sprintf( __( 'Do not forget to visit the <a href="%s">Settings > Discussion</a> area to add words to the blacklist and other usual settings regarding comments.', 'secupress' ), admin_url( 'options-discussion.php' ) ),
			),
		),
		'firewall'     => array(
