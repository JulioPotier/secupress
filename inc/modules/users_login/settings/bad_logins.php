...
secupress_add_settings_section( __( 'Limit Login Attempts', 'secupress' ) );
	...
	$select_args_options = apply_filters( 'module_' . $pluginnow, 
							array(	'limitloginattempts'	=> __( 'Limit the number of bad login attempts', 'secupress' ),
	...
	secupress_add_settings_field(
		...
		array(	'description' => __( 'You can temporary ban people who try to mess with the login page. This is recommanded to avoid to be victim of a brute-force.', 'secupress' ),
	...
	secupress_add_settings_field(
		...
		array(
			...
			'helper_description'  => array( 'description' => __( 'This feature is only available in the <b>Premium Version</b>.', 'secupress' ) .
									'<br>' .
									__( 'Once logged in, nobody can log in on your account at the same time as you.', 'secupress' ) ),
			'button' => array(
				'url'			=> '#',
	...
	secupress_add_settings_field(
		...
		array(	'description' => sprintf( __( 'Recommanded: %s', 'secupress' ), '10 - 50' ),
	...
	secupress_add_settings_field(
		...
		array(	'description' => sprintf( __( 'Recommanded: %s', 'secupress' ), '5 - 15' ),
