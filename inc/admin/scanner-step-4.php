		...
		<div class="secupress-step-content-footer secupress-flex secupress-flex-top secupress-flex-spaced">
			...
			<p>
				...
				if ( secupress_is_pro() ) {
					...
					?>
					<a href="<?php echo esc_url( 'https://secupress.me/' . __( 'pricing', 'secupress' ) ) ?>" type="button" title="<?php esc_attr_e( 'Get the Pro Version to export this report as PDF file.', 'secupress' ); ?>" target="_blank" class="secupress-button disabled shadow">
						<?php echo $export_pdf_btn; ?>
					</a>
					<br>
			...
			<div class="secupress-flex">
				...
				<div class="secupress-col-summary-text secupress-flex secupress-flex-spaced">
					...
					<p class="secupress-p1">
						<a href="<?php echo esc_url( 'https://secupress.me/' . __( 'pricing', 'secupress' ) ); ?>" class="secupress-button secupress-button-tertiary secupress-button-getpro">
							<span class="icon">
