				...
				<div class="secupress-sideads">
					...
					<div class="secupress-wprocket-ad secupress-product-ads">
						...
						<p class="secupress-cta">
							<a href="https://wp-rocket.me/" class="secupress-button"><?php _e( 'More info', 'secupress' );?></a>
						</p>
					</div>
					...
					<div class="secupress-imagify-ad secupress-product-ads">
						...
						<p class="secupress-cta">
							<a href="https://imagify.io/" class="secupress-button"><?php _e( 'More info', 'secupress' );?></a>
						</p>
					</div>
