...
class SecuPress_Scan_Admin_As_Author extends SecuPress_Scan implements iSecuPress_Scan {
	...
	protected static function init() {
		...
		self::$more_fix = __( 'The fix will ask you to assign the administrators\' posts to another user (and create it if needed), or downgrade this administrator as an author.', 'secupress' );
	}
