...
class SecuPress_Scan_Bad_Old_Plugins extends SecuPress_Scan implements SecuPress_Scan_Interface {
	...
	protected function init() {
		...
		if ( is_network_admin() ) {
			...
			$this->more_fix = __( 'This cannot be fixed from here yet. Please deactivate the chosen plugins in each site, then delete them from the network administration.', 'secupress' );
			$this->fixable  = false;
		} elseif ( ! is_multisite() ) {
