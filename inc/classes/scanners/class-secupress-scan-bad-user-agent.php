...
class SecuPress_Scan_Bad_User_Agent extends SecuPress_Scan implements SecuPress_Scan_Interface {
	...
	public static function get_messages( $message_id = null ) {
		$messages = array(
			...
			// "warning"
			100 => __( 'Unable to determine if your homepage is accessible by bad User Agents.', 'secupress' ),
			// "bad"
	...
	public function scan() {
		$response = wp_remote_get( add_query_arg( secupress_generate_key( 6 ), secupress_generate_key( 8 ), user_trailingslashit( home_url() ) ), array( 'redirection' => 0, 'user-agent' => '<script>', 'timeout' => static::get_timeout(), 'headers' => array( 'X-SecuPress-Origin' => __CLASS__ ) ) );
