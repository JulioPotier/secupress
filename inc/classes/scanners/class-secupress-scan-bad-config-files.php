...
class SecuPress_Scan_Bad_Config_Files extends SecuPress_Scan implements SecuPress_Scan_Interface {
	...
	protected function init() {
		...
		$this->more     = __( 'Some attackers will try to find some old and backed up config files to try to steal them. Avoid this kind of attack simply by removing them.', 'secupress' );
