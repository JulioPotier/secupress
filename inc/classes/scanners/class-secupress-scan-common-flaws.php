...
class SecuPress_Scan_Common_Flaws extends SecuPress_Scan implements SecuPress_Scan_Interface {
	...
	public function scan() {
		 ...
		 */
		++$nbr_tests;
		$response = wp_remote_get( add_query_arg( secupress_generate_key( 6 ), 'wp-config.php', user_trailingslashit( home_url() ) ), array( 'redirection' => 0, 'timeout' => 20, 'headers' => array( 'X-SecuPress-Origin' => __CLASS__ ) ) );
