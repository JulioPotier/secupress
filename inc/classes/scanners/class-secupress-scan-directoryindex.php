...
class SecuPress_Scan_DirectoryIndex extends SecuPress_Scan implements SecuPress_Scan_Interface {
	...
	public function scan() {
		$response = wp_remote_get( SECUPRESS_PLUGIN_URL . 'inc/DirectoryIndex', array( 'redirection' => 1, 'timeout' => 60, 'headers' => array( 'X-SecuPress-Origin' => __CLASS__ ) ) ); //// create the folder at root
