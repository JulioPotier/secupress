...
(function($) {
	...
	SPautoSized.resize = function( e ) {
		...
		if ( vlen != e.valLength || ewidth != e.boxWidth ) {
			...
			SPautoSized.textareaParentHeight( $( e ).closest('.secupress-textarea-container'), $( e ));
		}
	...
	// Expendable items
	var $expandables = $('.secupress-setting-row_bbq-headers_user-agents-list, .secupress-setting-row_bbq-url-content_bad-contents-list');

	$expandables.find('.secupress-textarea-container').after('<span class="secupress-expand-trigger"><i class="dashicons dashicons-plus" aria-hidden="true"></i></span>').attr('spellcheck', false);

	// change class on parent textarea on focus/blur
	$expandables.find('textarea').AutoSized()
	...
	// on click on (+) button
	$expandables.on('click.secupress', '.secupress-expand-trigger', function(){
		var $_this     = $(this),
