...
$this->set_section_description( __( 'You can change the name of the plugin, which will be shown on the plugins page when activated. Leave the plugin name empty to remove the White Label.', 'secupress' ) );
